    ...
    <div {...props}>
      ...
      <main>
        <LandingSection id="introduction" variant="callout">
          <h2 className="mb-4 text-3xl font-semibold text-foreground-strong">
        ...
        <LandingSection id="features" maxWidth="full">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-8">
              <article>
                <h5 className="mb-2 text-xl font-semibold text-foreground-strong">
                  (Eet)momenten
                </h5>
        ...
        <LandingSection id="cta" variant="callout">
          ...
          <Button
            className="bg-interactive px-8 py-3 text-lg text-on-interactive hover:bg-interactive-hover"
        ...
        <LandingSection id="future" maxWidth="full">
          <h2 className="mb-8 text-center text-3xl font-semibold text-foreground-strong">
            Binnenkort verwacht....
          </h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <article>
              <h3 className="mb-2 text-xl font-semibold text-foreground-strong">
                Offline beschikbaar
              </h3>
              <p className="text-base leading-relaxed text-foreground">
